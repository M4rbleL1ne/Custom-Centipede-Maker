...
public static class CustomCentiCalls
{
    ...
    public static bool SporeCloudInvulnerableCheck(SporeCloud self, int index) => self.room.abstractRoom.creatures[index].creatureTemplate.breedParameters is CustomCentiBreedParams props && props.Flags2.Get(SporeCloudImmune);
