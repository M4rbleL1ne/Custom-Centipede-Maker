...
public static class CustomCentiTemplates
{
    ...
    internal static Dictionary<string, int> s_templateHash = new()
    {
        { "Centiwing", K_Centiwing },
        { "Centipede", K_Centipede },
        { "RedCentipede", K_RedCentipede },
        { "SmallCentipede", K_SmallCentipede },
        { "AquaCenti", K_AquaCenti }
    };
